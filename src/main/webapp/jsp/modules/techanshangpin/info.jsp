									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group">
																								...
																								<input id="shangpinmingcheng" v-model="ruleForm.shangpinmingcheng" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>类型</label>
																								
																								<input id="leixing" v-model="ruleForm.leixing" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="shangpinxiangqing" v-model="ruleForm.shangpinxiangqing" readonly>
																							</div>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "techanshangpin/info/" + id,
