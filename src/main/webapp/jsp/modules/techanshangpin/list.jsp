									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																																															<label>商品名称 <input type="text" id="shangpinmingchengSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
																																																																																	<label>类型 <input type="text" id="leixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="shangpinbianhaoTh" class="sorting" onclick="sort('shangpinbianhao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">商品编号</th>
																																																			<th id="shangpinmingchengTh" class="sorting" onclick="sort('shangpinmingcheng')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">商品名称</th>
																																																			<th id="leixingTh" class="sorting" onclick="sort('leixing')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">类型</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">图片</th>
																																																																	<th id="shangpinxiangqingTh" class="sorting" onclick="sort('shangpinxiangqing')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">商品详情</th>
																																						
																																						
																																						
																																																			
																																																			<th id="priceTh" class="sorting" onclick="sort('price')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">价格</th>
	...
	<script >
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("techanshangpin/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("techanshangpin" + colName,"GET",{
		...
		function crossTable(id,crossTabName){
			...
			window.sessionStorage.setItem('crossTableName',"techanshangpin");
