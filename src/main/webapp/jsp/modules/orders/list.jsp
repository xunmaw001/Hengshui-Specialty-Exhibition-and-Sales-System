									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																						<label>订单编号 <input type="text" id="orderidSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
																																																																																																																																																												<label>商品名称 <input type="text" id="goodnameSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="orderidTh" class="sorting" onclick="sort('orderid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">订单编号</th>
																																																			<th id="tablenameTh" class="sorting" onclick="sort('tablename')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">商品表名</th>
																																																			<th id="useridTh" class="sorting" onclick="sort('userid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">用户id</th>
																																																			<th id="goodidTh" class="sorting" onclick="sort('goodid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">商品id</th>
																																																			<th id="goodnameTh" class="sorting" onclick="sort('goodname')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">商品名称</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">商品图片</th>
																																																																	<th id="buynumberTh" class="sorting" onclick="sort('buynumber')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">购买数量</th>
																																																			<th id="priceTh" class="sorting" onclick="sort('price')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">价格/积分</th>
																																																			<th id="discountpriceTh" class="sorting" onclick="sort('discountprice')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">折扣价格</th>
																																																			<th id="totalTh" class="sorting" onclick="sort('total')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">总价格/总积分</th>
																																																			<th id="discounttotalTh" class="sorting" onclick="sort('discounttotal')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">折扣总价格</th>
																																																			<th id="typeTh" class="sorting" onclick="sort('type')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">支付类型</th>
																																																			<th id="statusTh" class="sorting" onclick="sort('status')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">状态</th>
																																																			<th id="addressTh" class="sorting" onclick="sort('address')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">地址</th>
