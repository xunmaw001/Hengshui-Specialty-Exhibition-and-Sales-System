									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="orderid" v-model="ruleForm.orderid" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="goodid" v-model="ruleForm.goodid" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>商品名称</label>
																								
																								<input id="goodname" v-model="ruleForm.goodname" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="buynumber" v-model="ruleForm.buynumber" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>价格/积分</label>
																								
																								<input id="price" v-model="ruleForm.price" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>折扣价格</label>
																								
																								<input id="discountprice" v-model="ruleForm.discountprice" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>总价格/总积分</label>
																								
																								<input id="total" v-model="ruleForm.total" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>折扣总价格</label>
																								
																								<input id="discounttotal" v-model="ruleForm.discounttotal" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>支付类型</label>
																								
																								<input id="type" v-model="ruleForm.type" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>状态</label>
																								
																								<input id="status" v-model="ruleForm.status" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>地址</label>
																								
																								<input id="address" v-model="ruleForm.address" readonly>
																							</div>
