									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																																																																																																	<label>收藏名称 <input type="text" id="nameSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="useridTh" class="sorting" onclick="sort('userid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">用户id</th>
																																																			<th id="refidTh" class="sorting" onclick="sort('refid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">收藏id</th>
																																																			<th id="tablenameTh" class="sorting" onclick="sort('tablename')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">表名</th>
																																																			<th id="nameTh" class="sorting" onclick="sort('name')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">收藏名称</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">收藏图片</th>
