									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																						<label>商品类型 <input type="text" id="shangpinleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="shangpinleixingTh" class="sorting" onclick="sort('shangpinleixing')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">商品类型</th>
