											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																													...
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">图片</th>
																																																			...
																																																			<th id="priceTh" class="sorting" onclick="sort('price')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">单价</th>
																																																			<th id="discountpriceTh" class="sorting" onclick="sort('discountprice')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">会员价</th>
