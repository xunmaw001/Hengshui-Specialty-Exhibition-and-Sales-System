...
<body>
						...
						<div class="card">
							<div class="card-header">
								<div class="d-flex align-items-center">
									<h4 class="card-title">特产商品评论表统计</h4>
	...
	<script >
		...
		$.ajax({ 
			type: "GET",
			url: baseUrl+"value/discusstechanshangpin/"+xColumnName+'/'+yColumnName,
			data:{ },
		...
		function group(colName){
			$.ajax({ 
                type: "GET",
                url: baseUrl+"group/discusstechanshangpin/"+colName,
             	data:{	tableName: "discusstechanshangpin",
                    	columnName: colName
					 },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
