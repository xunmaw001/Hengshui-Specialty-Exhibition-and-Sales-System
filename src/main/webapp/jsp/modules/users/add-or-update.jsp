									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
											<div class="form-group">
												<label>用户名</label>
												<input class="form-control"  name="username" id="username" v-model="ruleForm.username">
											</div>	
											<div class="form-group">
												<label>密码</label>
												<input class="form-control"  name="password" id="password" v-model="ruleForm.password">
											</div>
											<div class="form-group">
												<label>角色</label>
												<input class="form-control"  name="role" id="role" value="管理员" readonly>
											</div>
											<div class="form-group">
												<label>创建时间</label>
												<input class="form-control"  name="addtime" id="addtime" v-model="ruleForm.addtime" readonly>
											</div>																																																																																																																																																																																											</form>
										</div>
									</div>
								</div>
								<div class="card-action">
									<button id="submitBtn" type="button" onclick="submit()" class="btn btn-success">提交</button>
