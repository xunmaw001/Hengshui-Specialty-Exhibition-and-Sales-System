											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="useridTh" class="sorting" onclick="sort('userid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">用户id</th>
																																																			<th id="adminidTh" class="sorting" onclick="sort('adminid')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">管理员id</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">提问</th>
																																																																	
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">回复</th>
																																																																	<th id="isreplyTh" class="sorting" onclick="sort('isreply')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">是否回复</th>
