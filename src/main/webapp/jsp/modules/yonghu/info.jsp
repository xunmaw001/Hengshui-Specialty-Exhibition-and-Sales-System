									...
									<div class="row">
										...
										<input id="updateId" name="id" type="hidden">
																					<div class="form-group">
																								...
																								<input id="zhanghao" v-model="ruleForm.zhanghao" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="shouji" v-model="ruleForm.shouji" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>邮箱</label>
																								
																								<input id="youxiang" v-model="ruleForm.youxiang" readonly>
																							</div>
											
																					<div class="form-group">
																								<label>身份证</label>
																								
																								<input id="shenfenzheng" v-model="ruleForm.shenfenzheng" readonly>
																							</div>
																					...
																					<div class="form-group">
																								...
																								<input id="money" v-model="ruleForm.money" readonly>
																							</div>
