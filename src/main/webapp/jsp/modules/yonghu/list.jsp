									...
									<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
										...
										<div class="col-sm-12">
											<div id="add-row_filter" class="dataTables_filter">
																																																																																																								<label>姓名 <input type="text" id="xingmingSearch" class="form-control form-control-sm" placeholder="" aria-controls="add-row"></label>
																																																																																	<label>性别</label>
																<select name="xingbie" id="xingbieSelect">
																																	<option value=" "> </option>
										...
										<thead>
											...
											<tr role="row">
													<th style="width: 10px;"><input type="checkbox" onclick="chooseAll()"></th>
																																						<th id="zhanghaoTh" class="sorting" onclick="sort('zhanghao')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">账号</th>
																																																			...
																																																			<th id="shoujiTh" class="sorting" onclick="sort('shouji')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">手机</th>
																																																			<th id="youxiangTh" class="sorting" onclick="sort('youxiang')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">邮箱</th>
																																																			<th id="shenfenzhengTh" class="sorting" onclick="sort('shenfenzheng')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">身份证</th>
																																																			
																													<th tabindex="0" aria-controls="add-row" rowspan="1" colspan="1" style="min-width: 100px;">头像</th>
																																																																	<th id="moneyTh" class="sorting" onclick="sort('money')" tabindex="0" aria-controls="add-row" rowspan="1" colspan="1">余额</th>
	...
	<script >
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
				  ...
				  touxiangImg.setAttribute('height','100px');
				  touxiangImg.setAttribute('width','100px');
